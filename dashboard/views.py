...
def home(request):
    contact_last = Contact.objects.filter(date__date=timezone.now() - timezone.timedelta(1)).count() # bu yerga gar " - timezone.timedelta(1) qo`shilsa bir kun oldingi kelgan xabarlari ko`rsatadi."
